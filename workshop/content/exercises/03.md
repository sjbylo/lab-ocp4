...
FIXME: The following is too wordy.... simplify it.
...
Wait for the build to finish.  This can take a few minutes! 
...
Use the following helper script to see the values that you will need to configure the webhook. 
...
FIXME: get instructions for adding a webhook 

Now, when you make a change to the code, commit and push it, a fresh build will be triggered. 

The following command makes a change to the Dockerfile, commits and pushes the change to GitHub.  This should trigger a
...
FIXME: Check this, get a up-to-date one and simplify it (remove unnecessary content). 
...
Copying blob sha256:5767aa5114e887f414eb5b748b35014b5450ca5c1b66f87f1e2c399662aba205
Copying config sha256:4efd91078c869feb60bcdbae4b6683cb12984fb20d4dc1bf208f1d7684375860
Writing manifest to image destination
Storing signatures
