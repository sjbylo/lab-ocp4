In this lab you will use _Source to Image_ to build and launch an application on OpenShift.
...
Run the command and see what it will do:
...
---
Optionally: If you are interested, configure a webhook in GitHub to trigger the s2i build on every code update.
